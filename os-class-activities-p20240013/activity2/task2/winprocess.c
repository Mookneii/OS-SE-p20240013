...
int main() {
     ...
     *
     * NOTE: The path to notepad.exe is typically:
     *   "C:\\Windows\\System32\\notepad.exe"
     *
     * If notepad.exe is not at this path on your system, open Task Manager,
     * run notepad manually, right-click the process, and select
     ...
     * notepad will stay open — close it manually when you're done observing.
     * WaitForSingleObject blocks until the child terminates.
     */
    printf("Parent: waiting for child (notepad) to exit...\n");
    printf(">>> Open Task Manager now and take a screenshot! <<<\n");
    printf(">>> Then close notepad to let this program finish. <<<\n");
